...
if __name__ == "__main__":
    ...
    argparser.add_argument('TAG', action='store', help='Tags', nargs='*')
    ...
    argparser.add_argument('-o', dest='OUTPUT_FILE', default='data/question_default.csv', help='Output file name ')
